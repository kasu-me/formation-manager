...
formationTemplates.addFormationTemplate(new FormationTemplate(0, "4両編成", [n => 1000 + n, n => 1100 + n, n => 1200 + n, n => 1300 + n]));
formationTemplates.addFormationTemplate(new FormationTemplate(0, "4両編成50番台", [n => 1050 + n, n => 1150 + n, n => 1250 + n, n => 1350 + n]));
formationTemplates.addFormationTemplate(new FormationTemplate(1, "3両編成", [n => 1400 + (n * 2 - 1), n => 1400 + (n * 2), n => 1500 + (n * 2 - 1)]));
formationTemplates.addFormationTemplate(new FormationTemplate(1, "3両編成50番台", [1450, 1550, 1650]));
formationTemplates.addFormationTemplate(new FormationTemplate(2, "10両編成", [n => `クハE233-${n}`, n => `モハE233-${n}`, n => `モハE232-${n}`, n => `サハE233-${500 + n}`, n => `モハE233-${200 + n}`, n => `モハE232-${200 + n}`, n => `サハE233-${n}`, n => `モハE233-${400 + n}`, n => `モハE232-${400 + n}`, n => `クハE232-${n}`], (n) => `T${n}編成`));
