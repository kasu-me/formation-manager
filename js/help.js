...
<div class="mku-tab-container" id="help-tab">
	...
	<div class="mku-tab-content" tab-title="編成表データ">
		...
		<h2>マスタ管理</h2>
		<p>本アプリのメイン画面で見えている編成表は、編成表のデータそのものではなく、現在指定されている現在年月をもとに編集されたテーブルです。その大本となる「データそのもの」のことは「マスタデータ」と呼んでいます。</p>
		<p>本アプリで編成や車両を操作する場合、「編成解除」や「廃車」といった操作がありますが、これらの機能はあくまでも現在年月で「編成解除」や「廃車」のタイムスタンプを押すだけのもので、編成や車両の存在が消えるわけではありません。</p>
